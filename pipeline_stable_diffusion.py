...
from modules.clip import FrozenCLIPEmbedderWithCustomWords
from models import UNet2DConditionModel, Hypernetwork
...
class StableDiffusionPipeline(DiffusionPipeline):
    ...
    def load_hypernet(self, filename, hypernet_name="no_name"):
        ...
        shared.hypernetworks = Hypernetwork(hypernet_name, enable_sizes)
        shared.hypernetworks.to(self.device)
        shared.hypernetworks.load(filename)
